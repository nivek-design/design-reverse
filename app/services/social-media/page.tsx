            ...
            <div className="max-w-4xl mx-auto text-center">
              <FadeIn direction="up">
                ...
                <p className="text-xl md:text-2xl text-purple-100 mb-8 leading-relaxed">
                  ...
                  para agências e negócios digitais que querem <strong>resultados reais</strong> e 
            ...
            <div className="max-w-4xl mx-auto">
              <FadeIn direction="up" className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Sabemos que a sua rotina é uma corrida contra o tempo. Entre planejar campanhas, 
                  atender clientes e analisar métricas, a gestão diária das redes sociais acaba se 
                  tornando uma tarefa complexa e demorada.
                </p>
              </FadeIn>
                ...
                {[
                  {
                    ...
                    description: "Dificuldade em manter a consistência nas postagens e interagir com o público em tempo real.",
                    color: "text-red-600",
                    bgColor: "bg-red-100"
                  },
                  {
                    ...
                    description: "O número de seguidores não cresce e o engajamento das publicações é cada vez menor.",
                  ...
                  },
                  {
                    ...
                    description: "Luta constante para encontrar ideias de conteúdo que realmente conectem com a audiência.",
                  ...
                  },
                  {
                    ...
                    description: "Insegurança ao analisar os dados e comprovar o ROI das ações para o seu cliente.",
                    color: "text-blue-600",
                    bgColor: "bg-blue-100"
                  },
                  {
                    ...
                    description: "Sentimento de estar sempre 'correndo atrás' das novas tendências e algoritmos.",
                  ...
                  },
                  {
                    ...
                    description: "Comunidade desconectada e baixa interação, resultando em oportunidades perdidas.",
                    color: "text-pink-600",
                    bgColor: "bg-pink-100"
                  }
                ].map((pain, index) => (
                  <HoverCard key={index} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div className={`${pain.bgColor} ${pain.color} w-12 h-12 rounded-lg flex items-center justify-center mb-4`}>
                ...
                <FadeIn direction="up">
                  <div className="bg-gradient-to-r from-purple-900 to-pink-900 text-white p-8 rounded-2xl">
                    <h3 className="text-2xl font-bold mb-4">
                      E se você pudesse delegar essa operação com total segurança?
                    </h3>
                    <p className="text-purple-100 text-lg">
                      Com a certeza de que a presença online do seu cliente está crescendo 
                ...
                <div className="lg:w-1/2">
                  <FadeIn direction="left">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                      ...
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"> Realmente Funciona</span>
                    </h2>
                    <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                      Nosso serviço foi desenhado para eliminar esses desafios. Atuamos como uma 
                      extensão da sua equipe, cuidando de toda a operação – do planejamento de 
                      conteúdo à análise de resultados.
                    </p>
                      ...
                      {[
                        {
                          ...
                          description: "Construímos uma audiência qualificada enquanto você ganha tempo para focar em novas estratégias."
                        },
                        {
                          icon: Award,
                          title: "Autoridade de Marca",
                          description: "Transformamos a marca do seu cliente em uma referência no nicho de mercado."
                        },
                        {
                          icon: MessageCircle,
                          title: "Engajamento que Converte",
                          description: "Criamos uma comunidade fiel que gera leads, vendas e defensores da marca."
                        }
                      ].map((benefit, index) => (
                ...
                <div className="lg:w-1/2">
                  <ScaleIn delay={0.3}>
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-200">
                      <h3 className="text-xl font-bold mb-6 text-center text-gray-900">Resultados Comprovados</h3>
                      
                      <div className="grid grid-cols-2 gap-6 mb-8">
                        <div className="text-center">
                          <div className="text-3xl font-bold text-purple-600 mb-2">+150%</div>
                          <div className="text-sm text-gray-600">Aumento Médio de Engajamento</div>
                        </div>
                        <div className="text-center">
                          <div className="text-3xl font-bold text-pink-600 mb-2">+70%</div>
                          <div className="text-sm text-gray-600">Geração de Leads</div>
                        </div>
                        <div className="text-center">
                          <div className="text-3xl font-bold text-purple-600 mb-2">3x</div>
                          <div className="text-sm text-gray-600">Crescimento de Seguidores</div>
                        </div>
                        <div className="text-center">
                      ...
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div className="text-sm text-gray-600">+50 Clientes Ativos</div>
                        </div>
                        <div className="flex items-center gap-1 mb-2">
                          {[1, 2, 3, 4, 5].map((i) => (
                            <Star key={i} className="h-4 w-4 text-yellow-400 fill-current" />
                          ))}
                          <span className="text-sm text-gray-600 ml-2">4.9/5 - Avaliação Média</span>
                        </div>
                      </div>
                    </div>
                  </ScaleIn>
            ...
            <div className="max-w-6xl mx-auto">
              <FadeIn direction="up" className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Estruturamos nossos pacotes para atender diferentes necessidades e orçamentos, 
                  sempre com foco em resultados e crescimento sustentável.
                </p>
              </FadeIn>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <HoverCard className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold mb-2 text-gray-900">Essencial</h3>
                    <p className="text-gray-600 mb-6">Para quem está começando</p>
                    <div className="text-4xl font-bold text-purple-600 mb-2">R$ 897</div>
                ...
                <HoverCard className="bg-gradient-to-br from-purple-600 to-pink-600 text-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 relative">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-purple-100 mb-6">O mais escolhido pelos clientes</p>
                ...
                <HoverCard className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold mb-2 text-gray-900">Performance</h3>
                    <p className="text-gray-600 mb-6">Para crescimento acelerado</p>
                    <div className="text-4xl font-bold text-pink-600 mb-2">R$ 2.497</div>
                    <div className="text-gray-500">/mês</div>
                  </div>
            ...
            <div className="max-w-6xl mx-auto">
              <FadeIn direction="up" className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600">
                  Resultados reais de quem já transformou suas redes sociais conosco.
                </p>
              </FadeIn>
                ...
                {[
                  {
                    ...
                    content: "Desde que a Design Reverse assumiu nosso Instagram, nosso engajamento cresceu 150% em 3 meses. Eles não apenas postam, eles criam uma verdadeira comunidade.",
                    rating: 5,
                  ...
                  },
                  {
                    ...
                    content: "Finalmente encontramos uma parceria de verdade. Nossa geração de leads através do LinkedIn aumentou 70% e o time está totalmente alinhado com nossa visão.",
                    rating: 5,
                    results: "+70% Leads"
                  },
                  {
                    ...
                    content: "O que mais me impressiona é a qualidade do conteúdo e a consistência. Nossa comunidade triplicou em 6 meses e as vendas seguiram o mesmo caminho.",
                    rating: 5,
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <FadeIn direction="up" className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Esclarecemos suas principais dúvidas sobre nossos serviços.</p>
            </FadeIn>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <AccordionContent className="px-6 py-4 bg-white">
                    Nossos contratos são flexíveis e podem ser cancelados com aviso prévio de 30 dias. Acreditamos que a qualidade do nosso trabalho deve ser o motivo para você permanecer conosco, não a obrigatoriedade contratual.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-2" className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <AccordionContent className="px-6 py-4 bg-white">
                    Nos planos Estratégico e Performance, oferecemos gestão básica de anúncios, mas o investimento em mídia paga é separado e fica por sua conta. Isso garante total transparência e controle sobre seus investimentos publicitários.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3" className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <AccordionContent className="px-6 py-4 bg-white">
                    Os primeiros resultados começam a aparecer entre 30 a 60 dias, com melhorias significativas geralmente visíveis a partir do terceiro mês. O crescimento orgânico nas redes sociais é um processo gradual mas consistente.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-4" className="border border-gray-200 rounded-lg overflow-hidden">
                  <AccordionTrigger className="px-6 py-4 hover:bg-gray-100 transition-all">
                    Quem irá criar o conteúdo? Posso aprovar antes de ser postado?
                  </AccordionTrigger>
                  <AccordionContent className="px-6 py-4 bg-white">
                    Nossa equipe de designers e copywriters cria todo o conteúdo. Você recebe um calendário editorial mensal para aprovação antes das postagens. Também oferecemos um processo de aprovação por WhatsApp para maior agilidade.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-5" className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <AccordionContent className="px-6 py-4 bg-white">
                    Após a contratação, agendamos uma reunião de alinhamento estratégico, onde entendemos sua marca, público e objetivos. Em seguida, desenvolvemos a estratégia de conteúdo e começamos a produção. Todo o processo leva cerca de 7 dias úteis.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <FadeIn direction="up">
              ...
              <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                Não deixe para amanhã o crescimento que pode começar hoje. Nossa análise gratuita 
                vai mostrar exatamente onde estão as oportunidades nas suas redes sociais.
              </p>
