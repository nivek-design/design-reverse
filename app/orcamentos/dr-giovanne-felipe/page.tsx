...
export default function OrcamentoDrGiovanneFelipe() {
  ...
  const phases = [
    {
      ...
      items: [
        ...
        "Pagina unica com secoes estrategicas (Hero, Sobre, Servicos, Depoimentos, Contato)",
    ...
    },
    {
      ...
      items: [
        ...
        "Desenvolvimento de 2 propostas de logotipo",
  ...
  const optionA = {
    ...
    subtitle: "Landing Page + Analytics + Marca + Identidade",
    value: 4300,
    description: "Pacote ideal para iniciar sua presenca digital profissional com marca propria e landing page moderna.",
    phases: [1, 2, 3, 4],
    highlight: false,
  }
  ...
  const optionB = {
    ...
    subtitle: "Tudo da Opcao A + Papelaria",
    value: 4800,
